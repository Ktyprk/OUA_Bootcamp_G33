...
public class FadeObjectBlockingObject : MonoBehaviour
{
    ...
    private void OnDrawGizmos()
    {
        if (Target != null && Camera != null)
        {
            ...
            Gizmos.DrawLine(Camera.transform.position, Target.transform.position + TargetPositionOffset);
            Gizmos.DrawSphere(Target.transform.position + TargetPositionOffset, 0.1f);
        }
    }
}
